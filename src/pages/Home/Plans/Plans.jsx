      ...
      <Box sx={{ display:'grid', gridTemplateColumns: 'repeat(3, auto)',gap:5 }}>
        <Card variant="outlined" sx={{ border: "2px solid #c6ac8f",maxWidth: 300 }}>
          <CardContent>
            ...
            <Button variant="contained" sx={{borderRadius:10}} color="tertiary" fullWidth size="small">Try Free For 1 Month</Button>
          </CardContent>
          <Divider sx={{ pt: 1 }} />
          <CardActions>
      
            <Typography variant="body2">
             Free for 1 Month.Then $10.99/month. Offer only Available If have not tried premium before
              <br />
            </Typography>
          </CardActions>
        </Card>
        <Card variant="outlined" sx={{border: "2px solid #8a7d6d",maxWidth: 300, }}>
          <CardContent>
          <Box sx={{ display: "flex", justifyContent: "space-between" }}>
              <Box>
                {" "}
            ...
            <Button variant="contained" sx={{borderRadius:10}} color="secondary" fullWidth size="small">Get Premium Duo</Button>
          </CardContent>
          <Divider sx={{ pt: 1 }} />
          <CardActions>
        ...
        <Card variant="outlined" sx={{ border: "2px solid #0a0908",maxWidth: 300 }}>
          <CardContent>
          <Box sx={{ display: "flex", justifyContent: "space-between", }}>
              <Box>
                {" "}
            ...
            <Button variant="contained" sx={{borderRadius:10}} color="primary" fullWidth size="small">Get Premium Duo</Button>
          </CardContent>
          <Divider sx={{ pt: 1 }} />
          <CardActions>
